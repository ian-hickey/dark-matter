...
component name="ExampleResource" hint="This is a REST controller" {
    ...
    public Response function greetByName(@QueryParam("name") String name) {
        ...
        if (isNotNull(name)) {
            ...
            var myStruct1 = {greeting: greeting, id: 1, name: "Ian", info: "1 Test st. Worcester, Ma."};
            var myStruct2 = {greeting: greeting, id: 2, name: "Admin", info: "1 Test st. Worcester, Ma."};
            var myArray  = [myStruct1, myStruct2];
